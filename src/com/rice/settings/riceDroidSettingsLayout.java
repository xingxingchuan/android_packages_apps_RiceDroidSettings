...
import com.rice.settings.fragments.About;
import com.rice.settings.fragments.Buttons;
import com.rice.settings.fragments.LockScreen;
import com.rice.settings.fragments.Miscellaneous;
import com.rice.settings.fragments.Navigation;
import com.rice.settings.fragments.Notifications;
import com.rice.settings.fragments.QuickSettings;
import com.rice.settings.fragments.Sound;
import com.rice.settings.fragments.StatusBar;
import com.rice.settings.fragments.UserInterface;

public class riceDroidSettingsLayout extends SettingsPreferenceFragment {

    private static final String TAG = "riceDroidSettingsLayout";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        getActivity().setTitle(R.string.rice_settings_title);
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        mContainer = container;
        View view = inflater.inflate(R.layout.rice_settings, container, false);
